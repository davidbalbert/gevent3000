...
class SSLSocket(socket):
    ...
    def __init__(self, sock, keyfile=None, certfile=None,
        ...
        if PY3: #use the SSLContext object
            if _context:
            ...
            #also, deal with the extra sock params 
            if sock is not None:
        ...
        try:
            ...
            if sys.exc_info()[1].args[0] != errno.ENOTCONN:
                raise
    ...
    def _real_connect(self, addr, connect_ex): #PY3
        if self.server_side:
    ...
    def connect(self, addr):
        ...
        if PY3:
            return self._real_connect(addr, False)
        socket.connect(self, addr)
